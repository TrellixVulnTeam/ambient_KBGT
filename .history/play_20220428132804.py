            ...
            for j in range(len(current_time_frame)):
                ...
                for m in range(len(note_time)):
                    ...
                    if m == len(note_time)-1:
                        ...
                        midiout.send_message(musx.note_off(2, phrase_chord[0], vel))
                        midiout.send_message(musx.note_off(3, phrase_chord[0], vel))
                        midiout.send_message(musx.note_off(4, phrase_chord[0], vel))
