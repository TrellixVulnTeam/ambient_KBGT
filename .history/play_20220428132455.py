        ...
        if current_section == 'C' or current_section == 'D':
            ...
            for j in range(len(current_time_frame)):
                ...
                for m in range(len(note_time)):
                    ...
                    midiout.send_message(musx.note_on(2, phrase_chord[0], vel))
                    midiout.send_message(musx.note_on(3, phrase_chord[0], vel))
                    midiout.send_message(musx.note_on(4, phrase_chord[0], vel))
